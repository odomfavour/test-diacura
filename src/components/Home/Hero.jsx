            ...
            <div className="container mx-auto w-[85%]">
                <div className="lg:flex lg:flex-row flex flex-col-reverse lg:pt-[90px] lg:gap-[140px] lg:mb-[90px] mb-[40px] pt-6">
                    ...
                    <div>
                        ...
                        <h3 className="lg:w-[512px] lg:h-[108px] lg:leading-[50px]  leading-10 lg:text-[40px] text-[32px] lg:mt-4 mt-4 font-extrabold text-[#062D45]  font-Open-sans " data-aos="fade-left">Get Expert Medical Help With Diabetes From Us</h3>

                        <p className="lg:w-[516px] lg:h-[108px] lg:mt-[50px] mt-4 lg:mb-0 mb-3 text-[16px] lg:text-[20px] font-normal font-Open-sans text-[#868686] " data-aos="fade-left">Welcome to DiaCura-Med, redefining diabetes management.
