      ...
      <div className="max-w-[35rem] lg:max-w-[75.0625rem]  mx-auto px-[1.5rem] mb-[7.19rem] lg:mb-[11.81rem] mt-[6.25rem] lg:mt-[7.88rem]">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-[3rem] lg:gap-[3.38rem] lg:border lg:border-[#CCC] lg:rounded-[0.875rem] lg:shadow-bigBox ">
          ...
          <div className="lg:w-[40.5625rem]">
            ...
            <Link
              to={"/"}
              className="lg:flex items-center hover:bg-[#9353e5] lg:justify-center lg:mx-0 flex justify-center mx-auto bg-[#107BC0] w-[9.0625rem] md:w-[12.25rem] h-[2.5rem] md:h-[3.5rem] py-[0.75rem] md:py-[1.12rem] text-white text-[0.875rem] md:text-[1.25rem] font-bold leading-normal rounded-[0.25rem]"
            >
              Learn more
            </Link>
          </div>
