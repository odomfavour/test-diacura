    ...
    <section>
      <div className="px-[1.5rem] py-[2.625rem] max-w-[74.8125rem] mx-auto">
        <div className="text-center">
            <h2 className="text-[1.5rem] font-bold leading-normal lg:text-[4rem] mb-[3.55rem] lg:mb-[4.88rem]">FAQs</h2>
        </div>
        ...
        <div>
          <ul className="flex flex-col gap-[2.25rem] mb-[4rem] lg:mb-[4.88rem]">
            {faqList.map((faq) => {
              ...
              return (
                <li key={id} className="p-[1rem] lg:py-[3rem] lg:px-[2.5rem] border border-[#CCC] rounded-[0.25rem] lg:rounded-[0.5rem]">
                  <h3 className="text-base lg:text-[2rem] font-bold leading-normal">
                    <span>{question}</span>
                  </h3>
                  <p className="mt-[1rem] lg:text-[1.5rem] lg:mt-[1.88rem] text-[#999] text-[0.75rem] font-semibold lg:font-normal leading-normal">{answer}</p>
                </li>
              );
            })}
          </ul>
