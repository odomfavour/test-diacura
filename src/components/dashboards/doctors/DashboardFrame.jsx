...
import DoctorsDashboardTab from "./DoctorsDashboardTab";
import DoctorsAppointmentsTab from "./DoctorsAppointmentsTab";
import DoctorsChatTab from "./DoctorsChatTab";
import DoctorsEducationTab from "./DoctorsEducationTab";
import DoctorsSettingsTab from "./DoctorsSettingsTab";
import { DoctorsMenuContextProvider } from "../../../context/DoctorSidebarContext";

const DashboardFrame = () => {
  const { activeTab, toggleNav, setToggleNav } = DoctorsMenuContextProvider();
    ...
    <section className="relative w-full overflow-hidden bg-[#F5F5F5]">
      <div className="lg:pt-[1.25rem] lg:pl-[1.25rem] lg:pb-[1rem] lg:pr-[2.88rem] md:px-[1rem]">
        ...
        <div className="px-[1rem] md:px-0">
          {activeTab === "Dashboard" && <DoctorsDashboardTab />}
          {activeTab === "Appointments" && <DoctorsAppointmentsTab />}
          {activeTab === "Chat" && <DoctorsChatTab />}
          {activeTab === "Education" && <DoctorsEducationTab />}
          {activeTab === "Settings" && <DoctorsSettingsTab />}
        </div>
      </div>
    </section>
  );
