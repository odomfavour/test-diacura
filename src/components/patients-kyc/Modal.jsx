            ...
            <div className="flex justify-items-center justify-center lg:mt-[240px]" >
                <div className="lg:flex mx:auto lg:justify-center lg:mt-[90px] shadow-lg rounded-3xl px-7 bg-[#FFF] lg:w-[500px] lg:h-[250px]">
                    <div>
                        ...
                        <p className="text-[#107BC0]  lg:w-[436px] lg:h-[72px] text-[24px] font-open-sans px-[0px] font-semibold mt-[20px] flex mx-auto text-center">Welcome to Diacura Med! We are excited to have you on board</p>
                        <div className="flex justify-end ">
                            <button onClick={() => setShowModal(true)} className=" bg-[#107BC0] mt-7 w-[100px] h-[40px] rounded text-[16px] font-dm-sans text-[#FFFF]">Okay</button>
                        </div>
